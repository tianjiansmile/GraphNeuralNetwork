...
def train(mnist):
        ...
        h_conv1 = tf.nn.relu(conv2d(x_image,W_conv1) + b_conv1)  # 28x28x1 与32个5x5x1滤波器
        ...
        # 结果约接近正确答案，交叉熵越小，其实看log函数就能看出端倪，正确结果_y与预测结果y_conv的乘积就是 loss = -xlog(p) p越接近与q loss越接近0
